...
# Hack:
# We use 'courses/tda283' as the course path.
# Then we can use the year subfolder as the lab path.
...
path_graders = path_course / '2025' / 'graders'
...
lab = SimpleNamespace(
    ...
    # Hack (see above).
    full_id = print_parse.from_dict({(): '2025'}.items()),
