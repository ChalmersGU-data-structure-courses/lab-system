...
class RequestAndResponses:
    ...
    def report_issue(self):
        ...
        """
        assert self.lab.config.report_key is not None
        issue, _title_data = self.responses[self.lab.config.report_key]
        return issue
    ...
    def process_request(self):
        ...
        self.lab.update_manager.mark_dirty(ids=[self.group.id])
