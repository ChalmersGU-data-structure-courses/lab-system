...
_course_path = PurePosixPath('courses/dat495')
...
group = SimpleNamespace(
    ...
    name = print_parse.regex_int('Grupp {}', flags = re.IGNORECASE),
...
grading_sheet = SimpleNamespace(
    ...
    spreadsheet = '16mmLdn3GXzcDPFAtJSH5y6iJWImAdsjBYEacE9L34GQ',
