...
from extra_1 import extra_1_list
...
path_course = PurePosixPath('courses/dat525')
...
grading_sheet = SimpleNamespace(
    ...
    spreadsheet = '1JUQSFWvpwQuGQlHaisuZJuvnbcJwj0S5uiOAOKKjDhY',
    ...
    template = ('1JUQSFWvpwQuGQlHaisuZJuvnbcJwj0S5uiOAOKKjDhY', 'Template'),
...
_group = SimpleNamespace(
    ...
    name = print_parse.regex_int('DAT525 lab group {}', flags = re.IGNORECASE),
...
_lab_config = SimpleNamespace(
    ...
    canvas_path_awaiting_grading = PurePosixPath('temp2') / 'lab-N-awaiting-grading.html',
