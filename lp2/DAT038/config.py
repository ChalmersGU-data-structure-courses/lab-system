...
path_course = PurePosixPath('courses/dat038')
...
grading_sheet = SimpleNamespace(
    ...
    spreadsheet = '1hLrhqe69mUFeAIS18nia347GdeZ3ZzHK2YlYkEL7gxk',
    ...
    template = ('1hLrhqe69mUFeAIS18nia347GdeZ3ZzHK2YlYkEL7gxk', 'Template'),
...
_group = SimpleNamespace(
    ...
    name = print_parse.regex_int('DAT038 lab group {}', flags = re.IGNORECASE),
