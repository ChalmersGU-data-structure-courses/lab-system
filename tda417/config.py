...
path_course = PurePosixPath('courses/lp1-data-structures/2024/tda417')
path_graders = PurePosixPath('courses/lp1-data-structures/2024/graders')
...
grading_sheet = SimpleNamespace(
    ...
    spreadsheet = '10I_9O-zFZCcisUo6dGNDqpnCkMO9Bp15T5ZklrS46zU',
    ...
    template = ('10I_9O-zFZCcisUo6dGNDqpnCkMO9Bp15T5ZklrS46zU', 'Template'),
