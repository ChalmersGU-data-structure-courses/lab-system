...
path_course = PurePosixPath() / 'courses' / 'data-structures' / 'lp4' / '2025'
...
grading_sheet = SimpleNamespace(
    ...
    spreadsheet='1r6DGJKIQR_KoS4nyu4GRNvSJG8GKGacLwmBLWAgYRlk',
    ...
    template=('1r6DGJKIQR_KoS4nyu4GRNvSJG8GKGacLwmBLWAgYRlk', 'Template'),
